export const Logo = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      {/* SUPER VPN text */}
      <text x="40" y="27" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="700" fill="white" letterSpacing="1">SUPER</text>
      <text x="100" y="27" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="300" fill="#60A5FA" letterSpacing="2">VPN</text>
      <defs>
